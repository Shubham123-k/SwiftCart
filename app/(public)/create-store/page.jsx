    ...
    try {
      ...
      if (["approved", "rejected", "pending"].includes(data.status)) {
        ...
        switch (data.status) {
          case "approved":
            setMessage(
              "Your store has been approved, you can now add products to your status from the dashboard",
            );
          ...
          case "pending":
            setMessage(
              "Your store status is pending, please wait for admin to approve your store",
            );
            break;
          ...
          >
            ...
            <div>
              ...
              <p className="max-w-lg">
                To become a seller on SwiftCart, submit your store details for
