...
const Footer = () => {
    ...
    const linkSections = [
        ...
        },
        {
            title: "CONTACT",
            links: [
                { text: "shubhamkbind69@gmail.com", path: '/', icon: MailIcon },
                { text: "+91 8081279629", path: '/', icon: PhoneIcon },
                { text: "Lucknow, Uttar Pradesh", path: '/', icon: MapPinIcon }
            ]
        }
    ];

    const socialIcons = [
        { icon: GithubIcon, link: "https://github.com/Shubham123-k" },
        { icon: InstagramIcon, link: "https://www.instagram.com/__shubhamkb__?igsh=MXR3NHQ2MWJ2dHlqdQ==" },
        { icon: TwitterIcon, link: "https://x.com/shubhamkbind69" },
        { icon: LinkedinIcon, link: "https://www.linkedin.com/in/shubham-bind-53305432b" },
    ]
        ...
        <footer className="mx-6 bg-white">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        <Link href="/" className="text-4xl font-semibold text-slate-700">
                            <Image src="/text.svg" alt="img" width={200} height={200}/>
                        </Link>
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2026 © SwiftCart All Right Reserved.
                </p>
            </div>
        </footer>
    );
